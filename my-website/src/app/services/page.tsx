    ...
    <div className="services-container">
      ...
      <div className="service-cards">
        <div className="service-card">
          <Image src="pic-1.png" alt="Camel Riding" className="service-image" />
          <h3>Camel Rides</h3>
          <p>Experience the beauty of the Sahara Desert on a guided camel ride.</p>
        </div>
        <div className="service-card">
          <Image src="pic-2.png" alt="Desert Camping" className="service-image" />
          <h3>Desert Camping</h3>
          <p>Enjoy a unique overnight experience under the stars in our desert camps.</p>
        </div>
        <div className="service-card">
          <Image src="pic-3.png" alt="Cultural Experiences" className="service-image" />
